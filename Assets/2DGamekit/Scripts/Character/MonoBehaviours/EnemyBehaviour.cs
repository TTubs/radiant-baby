...
namespace Gamekit2D
{
    ...
    public class EnemyBehaviour : MonoBehaviour
    {
        ...
        public void Shooting()
        {
            ...
            {
                obj.rigidbody2D.velocity = (m_TargetShootPosition - shootingOrigin.transform.position).normalized * shotSpeed;

                float angle = Mathf.Atan2(obj.rigidbody2D.velocity.y, obj.rigidbody2D.velocity.x) * Mathf.Rad2Deg;
