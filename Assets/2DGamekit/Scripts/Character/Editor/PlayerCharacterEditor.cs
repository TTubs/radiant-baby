...
namespace Gamekit2D
{
    ...
    public class PlayerCharacterEditor : Editor
    {
        ...
        SerializedProperty m_MaxPowerProp;
        ...
        readonly GUIContent m_MaxPower = new GUIContent("Max Power");
        ...
        void OnEnable ()
        {
            ...
            m_MaxPowerProp = serializedObject.FindProperty("maxPower");
        ...
        public override void OnInspectorGUI ()
        {
            ...
            if (m_RangedSettingsFoldout)
            {
                ...
                EditorGUILayout.PropertyField(m_MaxPowerProp, m_MaxPower);
            }
